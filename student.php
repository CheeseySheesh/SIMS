...
if($result){
    if(mysqli_num_rows($result)>0){
        ...
        echo "<th>Major</th><th>Email</th><th>แก้ไข</th><th>ลบ</th></tr>";
        while($row=mysqli_fetch_assoc($result)){
            ...
            echo "<td><button><a href='update_std_form.php?id=".$row["id"]."' style='text-decoration: none; color:black'>Edit</a></button></td>";
            echo "<td><button onclick='deleteRecord(".$row["id"].")' style='cursor: pointer;'>Delete</button></td></tr>";
        }
        echo "</table>";
    }
}
